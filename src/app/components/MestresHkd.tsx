                        ...
                        <div className="accordion-item">
                            ...
                            <div id="collapse_2" className="accordion-collapse collapse" aria-labelledby="heading_2" data-bs-parent="#accordionMestreHkd">
                                <div className="accordion-body">
                                    <p>ANTONIO JOSE RIBAS PAIVA</p>
                                    <p>BYONG CHU KIM</p>
                                    <p>SERGE PIERRE BAUBIC</p>
                                    <p>HAILSON NAKADA HWANG</p>
                                    <p>VILSON LEANDRO TADEU INACIO</p>
                        ...
                        <div className="accordion-item">
                            ...
                            <div id="collapse_3" className="accordion-collapse collapse" aria-labelledby="heading_3" data-bs-parent="#accordionMestreHkd">
                                <div className="accordion-body">
                                    <p>SUNG SOO JIN</p>
                                    <p>GIN SIK YUN</p>
                                    <p>CARLOS JOSE MACHUCA</p>
                                    <p>VITORIO MATIUZZI</p>
                                    <p>MARCOS ANTONIO DE OLIVEIRA GIANELLINI</p>
                                    <p>MISAEL DE LUNA DA SILVA</p>
